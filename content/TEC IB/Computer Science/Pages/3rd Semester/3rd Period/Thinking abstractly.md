Sometimes, when solving a problem, it's better to get rid of everything that we don't need so that we can focus on the problem itself. Abstract thinking means reflecting on events, ideas, attributes, and relationships in a general manner that hides all unnecessary details of specific objects.

>[!tldr]
>It means to get rid of all unnecessary elements when thinking about a problem.

>[!example]
>Abstract art is as its name implies. An abstract painting represents a principle or an idea, but doesn't deal with detailed description or representation of reality.
