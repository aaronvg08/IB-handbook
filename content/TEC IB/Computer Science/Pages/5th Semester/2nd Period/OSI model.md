The OSI model is a model that helps us understand how data travels on a network and keeps things organized. It has seven layers, going from bottom to top.
...
- **Data link**: Handles node-to-node data transfer between devices on the same network.
- **Physical**: Things that you can touch. Cables, machines, etc. Converts data into bits to carry it across physical network equipment.